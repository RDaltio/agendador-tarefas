package com.rdaltio.agendadortarefas.infrastructure.repository;
...
public interface TarefasRepository extends MongoRepository<TarefasEntity, String> {
    ...
    List<TarefasEntity> findByDataEventoBetweenAndStatusNotificacaoEnum(
            LocalDateTime dataInicial, LocalDateTime dataFinal, StatusNotificacaoEnum statusNotificacaoEnum);
